...
{
    public class AsigObservRepository : MasterRepository, IEnsamblesRepository
    {
        private string selectAll;
        private string insert;
        private string update;
        private string delete;
        public AsigObservRepository()
        {
            selectAll = "select *from Ensambles";
            insert = "";
            update = "update Ensambles set idObser=@idObser where idEnsamble=@idEnsamble";
        ...
        public int Adit(Ensambles entity)
        {
            ...
            parameters.Add(new SqlParameter("@idObser", entity.idObser));
