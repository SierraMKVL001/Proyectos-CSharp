...
namespace Presentacion.Form_Almacen
{
    public partial class AlmacenUI : Form
    {
        ...
        private void btnPendiente_Click_1(object sender, EventArgs e)
        {
            hideSubMenu();
        ...
        private void DatosInicio()
        {
            ...
            lblCategorias.Text = obj.CantCategorias;

            ProcEnsambles objPro1 = new ProcEnsambles();
            try
            {
                dGVEnsamblesPend.DataSource = objPro1.ListerEnsamPendientes();
        ...
        private void tmrDateHour_Tick(object sender, EventArgs e)
        {
