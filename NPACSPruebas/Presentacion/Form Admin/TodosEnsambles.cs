...
{
    public partial class TodosEnsambles : Form
    {
        int n = 0;
        DateTime fromDate = DateTime.Today;
        DateTime toDate = DateTime.Now;
        bool selectensam = false;
        public TodosEnsambles()
        {
            InitializeComponent();
        ...
        private void TodosEnsambles_Load(object sender, EventArgs e)
        {
            ListarEnsambles();
        }
        ...
        private void dGVEnsambles_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtSubtotal.Text = dGVEnsambles.Rows[n].Cells[6].Value.ToString();
            txtIVA.Text = dGVEnsambles.Rows[n].Cells[7].Value.ToString();
            txtTotal.Text = dGVEnsambles.Rows[n].Cells[8].Value.ToString();
            VerSelectEnsam();
            if (n >= 0)
            {
        ...
        private void btonCancelEnsam_Click(object sender, EventArgs e)
        {
            ...
            if (dGVEnsambles.SelectedRows.Count > 0)
            {
                if (MessageBox.Show("Seguro que desea Cancelar el Ensamble?", "Sistema de Ensambles",
