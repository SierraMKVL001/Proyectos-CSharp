...
namespace Presentacion.FormCompartidos
{
    public partial class FormProductos : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Seguro que desea Eliminar este Producto?", "Atencion",
        ...
        private void btnSaver_Click(object sender, EventArgs e)
        {
            ...
            {
                MensajeError("El campo Categoria no puede estar vacio");
            }
            else
            {
                if (cmbMarca.Text=="")
                {
                    MensajeError("El campo Marca no puede estar vacio");
                ...
                else
                {
                    ...
                    {
                        MensajeError("El campo Precio no puede estar vacio");
                    }
                    else
                    {
                        if (string.IsNullOrEmpty(txtStock.Text))
                        {
                            MensajeError("El campo Sotck no puede estar vacio");
                        }
                        else
                        {
                            if (cmbProvedor.Text=="")
                            {
                                MensajeError("El campo Provedor no puede estar vacio");
                            }
                            else
                            {
