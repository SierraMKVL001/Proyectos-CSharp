...
{
    public partial class ExportAlmVent : Form
    {
        ...
        private void obtDatosEnsam(int idEnsamble)
        {
            N_Ensambles neg = new N_Ensambles();
            E_Ensamble obj = new E_Ensamble();
            neg.DatosEnam(idEnsamble, obj);
            lblFolio.Text = obj.NumFolio;
            lblIVA.Text = obj.IVA;
            lblNombre.Text = obj.NCliente;
            ...
            try
            {
                lblEnsamblo.Text = objPro1.obtenerTecnico(idEnsamble);
            }
            catch (Exception ex)
            {
        ...
        private void ExportAlmVent_Load(object sender, EventArgs e)
        {
            obtDatosEnsam(Convert.ToInt32(lblId.Text));
            ListarPzas();
        }
        ...
        private void ExportAlmVent_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
