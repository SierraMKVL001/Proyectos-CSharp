...
{
    public partial class SelectDupClient : Form
    {
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                DuplicaEnsamble Ensamble = Owner as DuplicaEnsamble;
        ...
        private void SelectDupClient_Load(object sender, EventArgs e)
        {
            ListarClientes();
        }
        ...
        private void SelectDupClient_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
