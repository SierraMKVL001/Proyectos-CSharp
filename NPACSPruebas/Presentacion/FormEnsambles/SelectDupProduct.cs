...
{
    public partial class SelectDupProduct : Form
    {
        ...
        private void SelectDupProduct_Load(object sender, EventArgs e)
        {
            ListProductos();
        }
        ...
        private void SelectDupProduct_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
