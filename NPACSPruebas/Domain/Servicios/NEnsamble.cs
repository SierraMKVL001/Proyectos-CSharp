...
namespace Domain.Servicios
{
    ...
    {
        public static string Insertar(string NumFolio, int idCliente, int idEmpleado, int idTipo, DateTime Fecha, decimal total,decimal subTotal,decimal iVA, DataTable dtDetalles)
        {
        ...
        public static string InsertarObser(string NumFolio, int idCliente, int idEmpleado, int idTipo, DateTime Fecha, decimal total, decimal subTotal, decimal iVA, int idObser, DataTable dtDetalles)
        {
            DEnsamble Obj = new DEnsamble();
            Obj.NumFolio1 = NumFolio;
            Obj.IdCliente = idCliente;
            ...
            return Obj.InsertarObser(Obj, detalles);
        }
