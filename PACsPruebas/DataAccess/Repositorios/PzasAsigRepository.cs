...
{
    public class PzasAsigRepository:MasterRepository,IEnsamblesRepository
    {
        ...
        public PzasAsigRepository()
        {
            selectAll = "select *from Ensambles";
            insert = "";
            update = "update Ensambles set idOrdeno=@idOrdeno,idEstatus=@idEstatus where idEnsamble=@idEnsamble";
        ...
        public int Adit(Ensambles entity)
        {
            ...
            parameters.Add(new SqlParameter("@idOrdeno", entity.idOrdeno));
